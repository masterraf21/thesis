...
has a K-S test implementation in the KolmogorovSmirnov function, while the language
Python has the SciPy 2 library which has a K-S test implementation in functions
