...
This study \cite{regression-detection} proposes to perform regression detection
performance at the DevOps stage, i.e. at the level of the intended source code change
the main thing is to avoid detecting performance regressions after the app is deployed
and running in a production environment. There are two ways proposed by the research
This is to detect performance regressions at the DevOps stage, namely:
