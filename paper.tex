...
very strong evidence to reject $h_{0}$ but it means that $h_{0}$ cannot be rejected by too sure. Conversely, the smaller the significant value used, the smaller the value, the stronger the evidence needed to reject $h_{0}$ which means that $h_{0}$ can be rejected with more confidence.
