...
very strong evidence to reject $h_{0}$ but it means t$h_{a}$t $h_{0}$ cannot be rejected by too sure. Conversely, if the smaller the significant value used, the smaller the value will be the stronger the evidence needed to reject $h_{0}$ which means that $h_{0}$ can be rejected.
