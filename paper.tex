...
The Cummulative Analysis approach will be used to fullfil the first needs of the PRA system.

On the other hand, aggregation analysis can help to identify changes that not too visible on the performance of a service. When comparing two fruits
trace set, we can also see the latency contribution associated with the tag,
operations, and services and also see how these contributions change over time
time.
