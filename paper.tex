...
Open Source distributed tracing solution from Zipkin. Components to be made from scratch
is entirely the PRA User Interface (UI) and PRA Engine components of the system
PRA will perform the main computation of the detection system and regression analysis.
The PRA Engine component will also serve as an API that will be accessed by
PRA UI component.
