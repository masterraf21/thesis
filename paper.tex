...
Seeing the needs of the PRA system above, from the several approaches in the subchapter, the authors assess
There are two approaches that can be used, namely the Cumulative Analysis approach on
II.4.2 and Aggregation and Correlation Analysis approach in II.4.3.
