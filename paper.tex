...
\begin{table}[]
	\begin{tabular}{lllll}
		\hline
		\multicolumn{1}{|l|}{ID} &
		\multicolumn{1}{l|}{Service/Function} &
		\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Extra \\ Latency\end{tabular}} &
		\multicolumn{1}{l|}{User} &
		\multicolumn{1}{l|}{Desc.} \\ \hline
		\multicolumn{1}{|l|}{\textbf{IS1}} &
		\multicolumn{1}{l|}{CheckoutService/PlaceOrder} &
		\multicolumn{1}{c|}{100ms} &
		\multicolumn{1}{c|}{25} &
		\multicolumn{1}{l|}{Extra latency case \#1} \\ \hline
		&  &  &  &  \\
		&  &  &  &  \\
		&  &  &  &  \\
		&  &  &  &  \\
