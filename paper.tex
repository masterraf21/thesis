...
The next phase is the periodic analysis phase. This phase will run continously and the analysis will be run periodically at intervals of 5 minutes
very. This is done to continuously detect whether there is a regression and
