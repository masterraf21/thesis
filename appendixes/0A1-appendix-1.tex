...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.75\textwidth]{resources/ch4/json/1-yes.png}
	\caption{\textit{Response} JSON hasil pengujian kasus \textbf{SI1} dengan alpha 0.1}
	\label{result_json_1_y}
\end{figure}
