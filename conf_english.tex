...
the design and the underlying architecture of Inkle. Section IV shows the experiments done with Inkle. Section V discusses a
few analysis from the experiments done in Section V. Section
