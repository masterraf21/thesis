...
\begin{abstract}
In applications with a Microservice architecture, when a significant change occurs,
result in decreased performance or regression, it is difficult to perform analysis or
checking which part of the whole Microservice is the main cause
The regression is due to the distributed nature of Microservice. With the help of
distributed tracing can be analyzed to determine whether there is a regression
and the cause of the regression by utilizing latency data from existing operations
on Microservices applications.
This Final Project implements a Performance Regression Analysis system or
