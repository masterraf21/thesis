...
Dalam aplikasi dengan arsitektur Microservice, ketika terjadi perubahan yang mengakibatkan penurunan kinerja atau regresi, sulit untuk melakukan analisis atau pemeriksaan bagian mana dari keseluruhan Microservice yang menjadi penyebab utama regresi tersebut. Hal tersebut diakibatkan oleh sifat dari Microservice yang terdistribusi sehingga akan banyak kemungkinan penyebab regresi tersebut.
