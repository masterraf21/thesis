...
\begin{small}
	\begin{longtable}{ | p{3cm} | p{3cm} | p{3cm} | }
		...
		\endfirsthead
		\centering{Service Map} & \centering{\ding{51}} & \centering\arraybackslash{\ding{51}} \\ \hline
		\centering{Root Cause Analysis} & \centering{\ding{51}} & \centering\arraybackslash{\ding{51}} \\ \hline
	\end{longtable}
\end{small}
