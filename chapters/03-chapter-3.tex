...
\begin{enumerate}
	...
	\item Membuat perangkat untuk melakukan \textit{root cause analysis} (RCA) untuk memncapai tujuan kedua yaitu mengembalikan performa baseline ketika terjadi sebuah regresi pada sistem
\end{enumerate}
...
Sementara itu perangkat untuk melakukan RCA adalah 
