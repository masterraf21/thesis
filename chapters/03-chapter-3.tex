...
Dari pemaparan alur sistem \textit{Performance Regression Analysis} pada \ref{analisis-masalah}, dapat dirumuskan beberapa kriteria bagi sistem \textit{distributed tracing} yang akan digunakan
