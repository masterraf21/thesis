...
Sudah terdapat beberapa pendekatan dan algoritme yang dapat digunakan untuk melakukan analisis regresi seperti yang ada pada subbab \ref{ch2-algo}. Dari beberapa pendekatan yang ada pada subbab tersebut, ada dua pendekatan yang dapat digunakan 
