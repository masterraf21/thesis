...
\begin{small}
	\begin{longtable}{ | p{4cm} | p{5cm} | p{5cm} | }
		...
		\label{jzipkin-comparison}                                                                                                                \\ \hline
		 & \centering\bfseries{Zipkin} & \centering\bfseries{Jaeger} \tabularnewline \hline
		\endfirsthead
		Deskripsi Singkat & \centering{\ding{51}} & \centering\arraybackslash{\ding{51}} \\ \hline
		Kelebihan & \centering{\ding{51}} & \centering\arraybackslash{} \\ \hline
		Kekurangan & & \\ \hline
		Jenis Analisis tersedia \\ \hline
	\end{longtable}
\end{small}
