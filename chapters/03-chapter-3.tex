...
\begin{small}
	\begin{table}[]
		\caption{Tabel perbandingan fitur \textit{user interface} Zipkin dan Jaeger}
		\label{ui-comparison} 
		\begin{table}[]
			\centering
			\begin{tabular}{@{}lll@{}}
				\toprule
				\multicolumn{1}{c}{Nama Fitur}    & \multicolumn{1}{c}{Jaeger} & Zipkin                \\ \midrule
				\multicolumn{1}{|l|}{Service Map} & \multicolumn{1}{l|}{}      & \multicolumn{1}{l|}{} \\ \midrule
