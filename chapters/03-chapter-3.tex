...
Sehingga pada kasus deteksi regresi kinerja pada aplikasi berbasis Microservice, pendekatan kedua lebih cocok untuk digunakan agar d ap
...
Oleh karena itu, dapat dirumuskan alur kerja yang harus dilakukan oleh sistem \textit{Performance Regression Analysis} adalah sebagai berikut:
\begin{enumerate}
	\item Sistem harus dapat mendeteksi ketika terjadi regresi
