...
Gambar \ref{alur-pra} menggambarkan fase yang akan dilalui oleh sistem PRA. Secara umum, akan terdapat dua fase yang akan dilakukan yaitu fase \textit{baseline loading phase} dan fase \textit{realtime analysis phase}. 
