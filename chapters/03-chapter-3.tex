...
\begin{small}
	\begin{longtable}{ | p{2cm} | p{10cm} | }
		...
		FR-04 & Kakas dapat melakukan Root Cause Analysis (RCA) ketika terjadi sebuah regresi pada sistem dengan menggunakan pendekatan \textit{Aggregate and Correlation Root Cause Analysis}
	\end{longtable}
\end{small}
