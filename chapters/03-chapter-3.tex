...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=1.2\textwidth]{resources/ch3/alur.png}
...
Dari pemaparan alur sistem \textit{Performance Regression Analysis} pada \ref{analisis-masalah}, dapat dirumuskan beberapa kriteria sistem \textit{distributed tracing} yang akan digunakan sebagai berikut:
\begin{small}
