...
Dari penggunaan ketiga pilar tersebut, pada akhirnya \textit{observability} memiliki dua tujuan utama \citep{parker2020distributed}, yaitu:
\begin{enumerate}
	\item Meningkatkan performa \textit{baseline}
