...
Data hasil \textit{trace} yang berisi kumpulan \textit{span} kemudian direpresentasikan sebagai \textit{directed acylic graph} (DAG), yang mana \textit{edge} antar graf dalam DAG yang disebut dengan \textit{reference} merepresentasikan hubungan atau kausalitas antar komponen yang terjadi pada \textit{request}. 

%Seperti yang telah dijelaskan pada \ref{bab2-dtracing-causality} mengenai \textit{request causality}, suatu .
