...
Kakas yang digunakan untuk membantu mencapai \textit{observability} penting untuk meningkatkan performa \textit{baseline} dengan pertama kali mengukur performa awal yang menjadi \textit{baseline} pengukuran dan digunakan mengarahkan para \textit{developer} untuk mencari bagian mana dari aplikasi yang dapat ditingkatkan performanya. 
