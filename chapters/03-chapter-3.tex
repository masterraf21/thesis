...
Dari pemaparan alur sistem \textit{Performance Regression Analysis} pada \ref{analisis-masalah}, dapat dirumuskan beberapa kebutuhan bagi sistem \textit{distributed tracing} yang akan digunakan
