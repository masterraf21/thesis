...
Kakas yang digunakan untuk membantu mencapai \textit{observability} penting untuk meningkatkan performa \textit{baseline} dengan pertama kali mengukur performa awal yang menjadi \textit{baseline} pengukuran dan mengarahkan para \textit{developer} untuk mencari bagian mana dari aplikasi yang dapat ditingkatkan performanya. 
...
%Terkumpulnya data hasil \textit{trace} dapat menjadi alat yang dapat membantu para \textit{developer} untuk mencapai \textit{observability} pada sebuah \textit{cluster} sistem terdistribusi dengan beberapa cara, yaitu:
