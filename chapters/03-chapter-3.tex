...
\begin{small}
	\begin{longtable}{ | p{3cm} | p{10cm} |}
		...
		\endfirsthead
		TQ-1 & Komponen instrumentasi dapat menyediakan informasi kausalitas antar \textit{service} yang terjadi selama \textit{request} pada \textit{span} \\ \hline
		TQ-2 & Komponen \textit{deployment} menyediakan dukungan untuk Kubernetes \\ \hline
		TQ-3 & Komponen \textit{deplyoment} menyediakan dukungan untuk \textit{storage} eksternal \\ \hline
	\end{longtable}
\end{small}
