...
\section{Analisis Masalah}
 ...
 Dengan bantuan dari \textit{trace} atau teknik yang disebut \textit{distributed tracing}, \textit{developer} bisa mendapatkan suatu gambaran dari masing-masing \textit{request} yang terjadi 
