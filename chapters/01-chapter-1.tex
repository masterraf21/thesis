...
Bab tiga memaparkan analisis permasalahan yang terkait \textit{Performance Regression Detection} menggunakan \textit{distributed tracing} pada Microservice beserta rancangan solusi yang akan digunakan untuk mengatasi permasalahan tersebut. Selanjutnya solusi umum tersebut akan dibuat rancangan dan arsitekturnya agar dapat diimplementasikan.
