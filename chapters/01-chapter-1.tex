...
Tujuan yang ingin dicapai dalam Tugas Akhir ini adalah mengembangkan kakas solusi \textit{Distributed Tracing} bersifat yang dapat membuat visualisasi dari hasil \textit{tracing} sehingga \textit{developer} dapat mendapatkan \textit{observability} dari aplikasi \textit{Microservice}.
