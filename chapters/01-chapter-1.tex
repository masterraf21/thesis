...
\begin{enumerate}
	\item Mengembangkan kakas untuk melakukan \textit{Performance Regression Analysis} menggunakan \textit{distributed tracing}  pada aplikasi berbasis Microservice yang menggunakan protokol gRPC dan berjalan di atas Kubernetes
