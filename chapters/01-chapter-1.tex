...
\begin{enumerate}
	\item Mengembangkan kakas solusi \textit{distributed tracing}  yang dapat membuat visualisasi dari hasil \textit{tracing} sehingga \textit{developer} dapat mendapatkan \textit{observability} dari sebuah sistem \textit{Microservice} secara utuh.
