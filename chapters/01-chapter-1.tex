...
Di sisi lain, muncul suatu teknologi berupa protokol komunikasi antar Microservice bernaama gRPC \citep{grpc} yang merupakan hasil inkubasi dari Cloud Native Computing Foundation yang menawarkan keunggulan kinerja dibandingkan protokol komunikasi REST. 
