...
Seperti yang telah dijelaskan dalam Latar Belakang, masih adanya kekurangan dalam kakas untuk membuat visualisasi hasil \textit{distributed tracing} yang bersifat \textit{open source}. Oleh karena itu rumusan masalah yang akan dijawab pada Tugas Akhir ini adalah "Bagaimana membuat 

\section{Tujuan}

Tujuan yang ingin dicapai dalam Tugas Akhir ini adalah:
\begin{enumerate}
	\item Mengembangkan kakas solusi \textit{distributed tracing}  yang dapat nmenampilkan visualisasi dari hasil \textit{tracing} sehingga \textit{developer} dapat mendapatkan \textit{observability} dari sebuah sistem Microservice secara utuh
