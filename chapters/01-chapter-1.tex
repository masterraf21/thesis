...
\begin{enumerate}
	\item Mengembangkan kakas untuk melakukan \textit{Root Cause Analysis} menggunakan \textit{distributed tracing}  yang dapat menampilkan visualisasi dari hasil \textit{tracing} pada sistem Microservice yang berjalan di atas Kubernetes sehingga \textit{developer} dapat mendapatkan \textit{observability} dari sebuah sistem Microservice secara utuh
