...
Seperti yang telah dijelaskan dalam Latar Belakang, masih adanya kekurangan dalam kakas untuk membuat visualisasi hasil \textit{distributed tracing} yang bersifat \textit{open source}

\section{Tujuan}

Tujuan yang ingin dicapai dalam Tugas Akhir ini adalah:
\begin{enumerate}
	\item Mengembangkan kakas solusi \textit{distributed tracing}  yang dapat membuat visualisasi dari hasil \textit{tracing} sehingga \textit{developer} dapat mendapatkan \textit{observability} dari sebuah sistem Microservice secara utuh
...
\begin{enumerate}
	\item \textit{Library} instrumentasi yang digunakan pada level kode Microservice tidak akan dibuat dari awal namun akan mengimplementasikan solusi instrumentasi \textit{open source}
