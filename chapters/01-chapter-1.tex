...
\begin{enumerate}
	\item Mengembangkan kakas untuk melakukan \textit{Performance Regression Analysis} menggunakan \textit{distributed tracing}  yang dapat menampilkan visualisasi dari hasil \textit{tracing} pada sistem Microservice yang menggunakan protokol gRPC dan berjalan di atas Kubernetes
