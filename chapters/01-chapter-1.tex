...
Di sisi lain, muncul suatu teknologi berupa protokol komunikasi antar Microservice bernaama gRPC yang merupakan hasil inkubasi dari Google dan Cloud Native Computing Foundation yang menawarkan keunggulan kinerja dibandingkan protokol komunikasi REST \citep{grpc]. 
