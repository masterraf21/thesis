...
\begin{enumerate}
	\item Mengimplementasikan kakas solusi \textit{distributed tracing}  yang dapat membuat visualisasi dari hasil \textit{tracing} sehingga \textit{developer} dapat mendapatkan \textit{observability} dari sebuah sistem \textit{Microservice} secara utuh
	\item Mengukur \textit{overhead} yang diakibatkan oleh kakas solusi baik pada level aplikasi maupun level infrastruktur
\end{enumerate}
