...
Pada tugas akhir ini, dilakukan pengembangan kakas yang akan berfokus untuk melakukan \textit{Performance Regression Detection} .menggunakan hasil \textit{trace} yang dapat digunakan untuk mengembalikan kinerja sistem setelah terjadinya regresi. 
