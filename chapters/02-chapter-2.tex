...
Penelitian ini \citep{rca-alibaba} menggunakan \textit{distributed tracing} untuk melakukan diagnosa degradasi kinerja pada sebuah sistem dengan melakuan analisis graf pada level \textit{trace} secara \textit{real-time} untuk menentukan akar penyebab degradasi kinerja atau \textit{Root-cause}. Pendekatan ini dikembangkan berdasarkan profil kinerja, penelusuran, dan sistem logging di pusat data Alibaba untuk mempercepat diagnosis akar masalah secara real-time.
