...
OpenTraciong adalah sebuah \textit{framework} netral yang dapat digunakan untuk melakukan instrumentasi pada sistem \textit{distributed tracing} \citep{opentracing}
