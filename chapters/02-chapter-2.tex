...
\begin{enumerate}
	\item Melakukan deteksi regresi pada level \textit{source code} dengan melakukan ekstraksi setiap \textit{commit} pada Git dan mengindentifikasi kasus uji mana saja yang terkena dampak regresi pada setiap \textit{commit}.
\end{enumerate}
