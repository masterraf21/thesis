...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.1\textwidth]{resources/ch3/ks.png}
...
Tabel \ref{corr-tab-1} menunjukkan bahwa ada korelasi kuat antara versi baru dari \textit{service} "inventory" dengan hasil \textit{trace} terbaru, 
