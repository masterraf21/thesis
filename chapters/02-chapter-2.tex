...
\begin{enumerate}
	...
	\item Memprediksi tes mana yang dapat memanifestasikan regresi pada level \textit{commit}. Pendekatan ini merupakan kelanjutan dari poin sebelumnya yang mana pendekatan dengan melakukan uji pada setiap \textit{commit} 
\end{enumerate}
