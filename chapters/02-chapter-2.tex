...
\subsection{Menentukan \textit{Critical Path}}
\label{approach-cp}
...
Langkah pertama dalam menggunakan pendekatan ini adalah dengan membagi hasil \textit{trace} menjadi dua bagian sampel, kedua hal ini akan menjadi basis bagi semua perbandingan kedepannya. 
