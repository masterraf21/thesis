...
\begin{enumerate}
	...
	\item Analisis penyebab regresi dilakukan dengan membandingkan \textit{latency} dari Critical Path dari semua \textit{trace} yang diperoleh dari data \textit{trace} Zipkin. 
