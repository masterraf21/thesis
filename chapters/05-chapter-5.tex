...
\begin{enumerate}
	...
	\item Analisis penyebab regresi dilakukan dengan membandingkan \textit{latency} dari \textit{Critical Path} dari semua \textit{trace} yang diperoleh dari data Zipkin. 
