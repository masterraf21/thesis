...
\begin{enumerate}
	...
	\item Hasil pengujian menunjukkan sistem PRA telah berhasil menguji 10 dari 11 kasus regresi atau sekitar 90\% kasus. Satu-satunya kasus regresi gagal terdeteksi adalah kasus dengan penambahan \textit{latency} 100ms. Pada kasus ini regresi tidak terdeteksi karena algoritme tidak menganggap penambahan \textit{latency} sebanyak 100ms pada sebuah operasi menjadikan keseluruhan sampel data menjadi berbeda distribusi dengan sampel data \textit{baseline} sehingga sistem tidak dapat mendeteksi terjadinya regresi.
