...
Aplikasi yang akan digunakan untuk melakukan pengujian sistem PRA adalah aplikasi Online Boutique \citep{Lisa_My_Research_Software_2017} yang merupakan aplikasi \textit{e-commerce} berbasis web yang dibuat untuk mendemostrasikan berbagai macam teknologi yang dimiliki oleh Google. 
