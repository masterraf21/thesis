...
Modul-modul pada tabel \ref{engine-module} masing-masing akan diimplementasikan sebagai \textit{package} pada bahasa \textit{Python} seperti yang terlihat pada gambar \ref{}. Terdapat tuyjuh buah \textit{package}, enam buah \textit{package} dari modul dan satu buah package \textttt{utils} yang berisi fungsi-fungsi untuk mendukung kerja fungsi di modul lainnya. 
