...
Dapat diartikan, penggunaan nilai signifikan pada PRA Engine akan berpengaruh pada hasil terutama jika kasus regresi yang ingin dideteksi tidak memiliki perubahan yang sangat berarti pada nilai \textit{latency}-nya seperti yang terdapat pada kasus SI1. Dapat disimpulkan bahwa semakin besar nilai signifikan, akan semakin sensitif juga algoritma dalam mendeteksi regresi yang terjadi sebab tidak diperlukan bukti yang sangat kuat untuk menolak $h_{0}$, namun  semakin kecil nilai signifikan yang digunakan akan semakin kuat juga bukti yang diperlukan untuk menolak $h_{0}$.
