...
Seperti yang terlihat pada gambar \ref{result_json_6}, regresi terdeteksi namun analisis \textit{critical path} tidak dapat menentukan sumber regresi yang seharusnya adalah operasi \texttt{placeorder} dari \textit{service} \texttt{CheckoutService} karena .
\begin{figure}[!htb]
	\centering
...
Seperti yang terlihat pada gambar \ref{result_json_7}, regresi terdeteksi dan analisis \textit{critical path} dapat menentukan sumber regresi yaitu operasi \texttt{placeorder} dari \textit{service} \texttt{CheckoutService}.
\begin{figure}[!htb]
	\centering
