...
\begin{figure}[!htb]
	...
	\caption{Penggunaan CPU pada kasus \textbf{SI8}}
	\label{result_cpu_8}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{Penggunaan Memory pada kasus \textbf{SI8}}
	\label{result_mem_8}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{Penggunaan CPU pada kasus \textbf{SI9}}
	\label{result_cpu_9}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{Penggunaan Memory pada kasus \textbf{SI9}}
	\label{result_mem_9}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{Penggunaan CPU pada kasus \textbf{SI10}}
	\label{result_cpu_10}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{Penggunaan Memory pada kasus \textbf{SI10}}
	\label{result_mem_10}
\end{figure}
