...
\begin{small}
	\begin{longtable}{ | p{1cm} | p{5cm} | p{5cm} | }
		...
		2 & CheckoutService &  placeorder \\ \hline
		3 & CurrencyService &  checkout \\ \hline
		4 & EmailService &  sendorderconfirmation \\ \hline
		5 & PaymentService &  charge \\ \hline
		6 & ProductCatalogService &  getproduct \\ \hline
		7 & RecommendationService &  listredommendations \\ \hline
		8 & ShippingService &  getquote \\ \hline		
	\end{longtable}
\end{small}
