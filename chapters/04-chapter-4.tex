...
\begin{small}
	\begin{longtable}{ | p{1cm} | p{3cm} | p{10cm} | }
		...
		EM-4 & Perhitungan Statistik & Modul ini bertanggung jawab untuk melakukan komputasi perhitungan statistik yang mencakup pendeteksian regresi dengan menghitung koefisien Kosmolgorov-Smirnov seperti yang telah dijelaskan pada subbab \ref{approach-cumulative} \\ \hline
