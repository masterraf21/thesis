...
\subsubsection{Kasus SI5}
Dari gambar \ref{result_cpu_4} dan \ref{result_mem_4} terlihat bahwa \textit{engine} menggunakan \textit{resource} CPU sebanyak 0.064 \textit{core} dan Memory sebanyak 153.61 MiB. 
