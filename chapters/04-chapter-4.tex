...
berjalan pada platform Google Cloud. Aplikasi Hipster Shop akan diinstrumentasikan menggunakan Zipkin untuk menyimulasikan lingkungan \textit{distributed tracing} yang menggunakan Zipkin.
