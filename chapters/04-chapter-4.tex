...
Pengujian seperti pada tabel \ref{testcase} seluruhnya dilakukan dengan cara terlebih dahulu melakukan \textit{deployment} masing-masing kasus uji di lingkungan Kubernetes kemudian menjalankan aplikasi Load Generator sesuai dengan spesifikasi masing-masing kasus uji selama $\pm 5$ menit. Hasil akhir dari setiap kasus uji akan berupa response dalam bentuk JSON dari API dan juga log dari aplikasi untuk mengetahui hasil tes\ statistik K-S yang akan dipergunakan untuk keperluan analisis selanjutnya.
