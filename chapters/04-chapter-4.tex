...
\begin{small}
	\begin{adjustwidth}{-3cm}{}
		\begin{longtable}{ | p{0.7cm} | p{3.5cm} | p{3.5cm} | p{3.5cm} | }
			\caption{Kasus-kasus pengujian}
			\label{testcase}                                                           
			\\ \hline
			\centering\bfseries{ID} & \centering\bfseries{Service (Fungsi)} & \centering\bfseries{Nama Fungsi} & \centering\bfseries{Metode} \tabularnewline \hline
			\endfirsthead
			I1 & AdService &  cookware & hoo \\ \hline
