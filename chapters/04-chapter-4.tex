...
%	\begin{adjustwidth}{-3cm}{}
		\hskip-4.0cm\begin{longtable}{ | p{0.7cm} | p{3.5cm} | p{3.5cm} | p{3.5cm} | }
			\caption{Kasus-kasus pengujian}
			\label{testcase-i}                                                           
			\\ \hline
			\centering\bfseries{ID} & \centering\bfseries{Service (Fungsi)} & \centering\bfseries{Metode} & \centering\bfseries{Extra Latency} \tabularnewline \hline
			\endfirsthead
