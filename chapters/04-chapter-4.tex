...
Aplikasi yang akan digunakan untuk melakukan pengujian sistem PRA adalah aplikasi Online Boutique \citep{Google_Cloud_Platform_Microservices_Demo} yang merupakan aplikasi \textit{e-commerce} berbasis web yang dibuat untuk mendemostrasikan berbagai macam teknologi yang dimiliki oleh Google. 
