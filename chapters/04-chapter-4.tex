...
Pada tahap pendeteksian regresi dengan analisis statistik Kolmogorov-Smirnov, data yang diperlukan adalah data \textit{latency} atau durasi operasi \textit{span} yang dimiliki oleh Zipkin. 
