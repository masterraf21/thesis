...
Aplikasi yang akan digunakan untuk melakukan pengujian sistem PRA adalah aplikasi Online Boutique yang merupakan aplikasi \textit{e-commerce} berbasis web yang dibuat untuk mendemostrasikan berbagai macam teknologi yang dimiliki oleh Google. 
