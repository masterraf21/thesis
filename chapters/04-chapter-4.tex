...
\begin{small}
	\begin{longtable}{ | p{1cm} | p{2cm} | p{3cm} | p{7.5cm} | }
		...
		EP-2 & \centering{POST} & \centering\texttt{/baseline} & Dengan \textit{endpoint} ini, \textit{user} dapat membuat \textit{engine} mengambil data \textit{baseline} baru dengan menyuplai informasi mengenai waktu mulai dan waktu akhir trace di Zipkin beserta dengan batas banyaknya \textit{trace} yang akan diambil\\ \hline		
