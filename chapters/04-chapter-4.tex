...
Gambar \ref{result_log_1} merupakan \textit{log} yang didapatkan dari kasus SI1 yang menampilkan hasil tes statistik K-S. Kasus SI1 yang menyimulasikan terjadinya regresi dengan menambahkan \textit{latency} sebanyak 100ms 
