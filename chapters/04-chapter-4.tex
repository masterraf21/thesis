...
Berikut adalah hasil tangkapan layar dokumentasi API yang disediakan oleh FastAPI beserta hasil pemanggilan API yang dilakukan dengan aplikasi Postman \footnote{\url{https://www.postman.com/}}.
\begin{figure}[!htb]
	\centering
	\includegraphics[width=1\textwidth]{resources/ch4/api_docs.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.2\textwidth]{resources/ch4/result_state.png}
	\caption{Implementasi modul sebagai \textit{package}}
	\label{package}
\end{figure} 
