...
Berikut adalah hasil tangkapan layar dokumentasi API yang disediakan oleh FastAPI beserta hasil pemanggilan API yang dilakukan dengan aplikasi Postman \footnote{\url{wwww.postman.com}}.
