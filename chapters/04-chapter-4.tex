...
Seperti yang terlihat pada gambar \ref{result_json_1}, regresi tidak terdeteksi pada kasus ini sehingga analissi \textit{critical path} tidak dijalankan.
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.75\textwidth]{resources/ch4/json/1.png}
	\caption{\textit{Response} JSON hasil pengujian kasus SI1}
	\label{result_json_1}
\end{figure}
...
Seperti yang terlihat pada gambar \ref{result_json_2}, regresi terdeteksi dan analisis \textit{critical path} dapat menentukan sumber regresi yaitu operasi \texttt{placeorder} dari \textit{service} CheckoutService.
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.75\textwidth]{resources/ch4/json/2.png}
	\caption{\textit{Response} JSON hasil pengujian kasus SI2}
	\label{result_json_2}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{\textit{Response} JSON hasil pengujian kasus SI3}
	\label{result_json_3}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{\textit{Response} JSON hasil pengujian kasus SI4}
	\label{result_json_4}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{\textit{Response} JSON hasil pengujian kasus SI5}
	\label{result_json_5}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{\textit{Log} hasil pengujian kasus SI5}
	\label{result_log_5}
\end{figure}
\pagebreak
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.75\textwidth]{resources/ch4/json/1.png}
	\caption{\textit{Response} JSON hasil pengujian kasus SI6}
	\label{result_json_6}
\end{figure}
