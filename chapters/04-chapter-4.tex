...
\begin{small}
	\begin{longtable}{ | p{5cm} | p{8cm} | }
		...
		\textit{Instance Type} & n1-highcpu-2 (2 vCPU,  1,8 GiB RAM) \\ \hline
...
untuk menyimulasikan pengunaan aplikasi oleh sejumlah user. Selain itu Hipster Shop juga memiliki akan mengirimkan data trace dan penggunaan resource ke StackDriver (atau sekarang disebut Google Cloud Platform Monitoring) jika
