...
\begin{table}[]
	\begin{tabular}{lllll}
		\cline{1-4}
		\multicolumn{1}{|c|}{ID} & \multicolumn{1}{c|}{Service (Fungsi)} & \multicolumn{1}{l|}{Extra Latency} & \multicolumn{1}{l|}{User} & Keterangan              \\ \cline{1-4}
		I1                       & CheckoutService (placeorder)          & 100ms                              & 25                        & Kasus extra latency \#1
	\end{tabular}
\end{table}
