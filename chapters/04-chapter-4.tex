...
\begin{table}[]
	\begin{tabular}{|l|l|c|c|l|}
		...
		\multicolumn{1}{|c|}{\cellcolor[HTML]{333333}{\color[HTML]{FFFFFF} \textbf{ID}}} &
		\multicolumn{1}{c|}{\cellcolor[HTML]{333333}{\color[HTML]{FFFFFF} \textbf{Service (Fungsi)}}} &
		\multicolumn{1}{l|}{\cellcolor[HTML]{333333}{\color[HTML]{FFFFFF} \textbf{Extra Latency}}} &
		\multicolumn{1}{l|}{\cellcolor[HTML]{333333}{\color[HTML]{FFFFFF} \textbf{User}}} &
		{\color[HTML]{FFFFFF} \textbf{Keterangan}} \\ \hline
		I1 &
		CheckoutService (placeorder) &
		100ms &
		25 &
		Kasus extra latency \#1 \\ \hline
		I2 &
		CheckoutService (placeorder) &
		250ms &
		25 &
		Kasus extra latency \#2 \\ \hline
		I3 &
		CheckoutService (placeorder) &
		350ms &
		25 &
		Kasus extra latency \#3 \\ \hline
		I4 &
		CheckoutService (placeorder) &
		250ms &
		75 &
		\begin{tabular}[c]{@{}l@{}}Kasus extra latency \\ dengan peningkatan user \#1\end{tabular} \\ \hline
		I5 &
		CheckoutService (placeorder) &
		250ms &
		150 &
		...
		- &
		25 &
		Kasus peningkatan kerja CPU \\ \hline
		&
		CheckoutService (placeorder) &
		&
		&
		\\ \cline{2-2}
		&
		\begin{tabular}[c]{@{}l@{}}ProductCatalog (getproduct\\ listproducts)\end{tabular} &
		&
		&
		\\ \cline{2-2}
		&
		...
		\multirow{-4}{*}{250ms} &
		\multirow{-4}{*}{25} &
		\multirow{-4}{*}{\begin{tabular}[c]{@{}l@{}}Kasus extra latency\\  dengan beberapa service\end{tabular}} \\ \hline
	\end{tabular}
\end{table}
